...
from infra.kis_auth import KisAuth   # ← 수정: token_manager → kis_auth
...
def run_ema_debug():
    ...
    print("\n[Step 1] API 연결 중...")
    try:
        tm = KisAuth()           # ← 수정: TokenManager → KisAuth
        api = KisApi(tm)
        print("  ✅ 연결 성공")
